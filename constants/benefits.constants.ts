...
export const BENEFITS_LIST = [
  {
    Icon: IdCard,
    title: "Physical ID & Membership Certificate",
    description:
  ...
  {
    Icon: UsersRound,
    title: "Network with other finance students nationwide",
    description:
